...
var _ = Describe("OpenStackCluster controller", func() {
	...
	It("should fail when namespace is denied access to ClusterIdentity and set OpenStackCredentialsAvailableCondition to False", func() {
		...
		// Verify OpenStackCredentialsAvailableCondition is set to False
	...
	It("should set OpenStackCredentialsAvailableCondition to False when credentials secret is missing", func() {
